...
export function $n(selector: string, parent: Document | HTMLElement = document): HTMLElement | null {
  return parent.querySelector<HTMLElement>(selector);
}

// 元素变化监听
export function fnElChange(el: HTMLElement, fn = (mr: MutationRecord[], mo: MutationObserver) => {
  console.log(mr, mo);
}) {
